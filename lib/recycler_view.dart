...
class _RecyclerViewState extends State<RecyclerView> {
  ...
  Widget ImageBody(){
    ...
    return Container(
      ...
      margin: EdgeInsets.all(18),
      alignment: Alignment.topCenter,
//      child: Image.network(widget.source, scale: 0.5,),
    child: image);
  }
  ...
  Widget IconBody(){
    return Container(
      ...
      margin: EdgeInsets.all(18),
      alignment: Alignment.topCenter,
      child: Icon(Icons.people,size: 128,color: Colors.green,),
    );
  }
}
